...
--
-- Table structure for table `match_updator_task`
--

DROP TABLE IF EXISTS `match_updator_task`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `match_updator_task` (
  `MATCH_UPDATOR_ID` int NOT NULL,
  `TOURNAMENT_ID` int NOT NULL,
  PRIMARY KEY (`MATCH_UPDATOR_ID`),
  CONSTRAINT `match_updator_id_1` FOREIGN KEY (`MATCH_UPDATOR_ID`) REFERENCES `users` (`UID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `match_updator_task`
--

LOCK TABLES `match_updator_task` WRITE;
/*!40000 ALTER TABLE `match_updator_task` DISABLE KEYS */;
INSERT INTO `match_updator_task` VALUES (4,1),(8,1);
/*!40000 ALTER TABLE `match_updator_task` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `matches` VALUES (1,1,1,2,NULL,NULL,0,'Pune','2023-03-20',NULL),(2,3,1,3,NULL,NULL,0,'London','2023-03-16',NULL),(3,3,2,4,NULL,NULL,0,'Chelsea','2023-03-30',NULL),(4,1,1,3,NULL,NULL,0,'pune','2023-03-16',NULL),(5,5,2,4,NULL,NULL,0,'ch vs mcfc','2023-03-07',NULL);
...
INSERT INTO `teams` VALUES (1,'Manchester United F.C.',3,'2021-02-03',' Manchester United','https://img.freepik.com/free-vector/logo-template-design_1195-105.jpg?size=338&ext=jpg',1),(2,' Manchester City F.C.',5,'2021-02-04',' Manchester City F.C.','https://img.freepik.com/free-vector/vintage-sport-club-logo-design_23-2149530935.jpg?size=338&ext=jpg',1),(3,'Liverpool FC',6,'2021-02-05','Liverpool FC','https://th.bing.com/th/id/OIP.qROzuVuLmBA4m-hKqkgJowHaHa?w=178&h=180&c=7&r=0&o=5&dpr=1.6&pid=1.7',1),(4,'Chelsea FC',7,'2021-02-06','Chelsea FC','https://th.bing.com/th/id/OIP.PXyZBa_6eIAehnHLx-Bi_QAAAA?w=271&h=204&c=7&r=0&o=5&dpr=1.6&pid=1.7',1);
...
INSERT INTO `tournaments` VALUES (1,'ScoreZone Cup -2023',2,'2023-03-14','2023-03-16','2023-03-10',1,NULL),(3,'Knowit',2,'2023-03-18','2023-04-09','2023-03-30',0,NULL),(4,'Knowit',2,'2023-03-09','2023-03-11','2023-03-09',0,NULL),(5,'dy patil cup',2,'2023-03-07','2023-03-09','2023-03-06',0,NULL);
...
-- Dump completed on 2023-03-10 22:54:41
